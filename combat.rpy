...
label start_fight_miniQuest1:
    ...
    # Create mini boss
    $e = Enemy("apprentice", "Aprentice Wizard", 100, 25, 15, lt_1, 20, 10)
...
label start_fight_quest1:
    ...
    # Create boss
    $e = Enemy("wizard", "Tuba Wizard", 400, 50, 15, lt_1_boss, 100, 20)
...
label start_fight_miniQuest2:
    ...
    # Create mini boss
    $e = Enemy("gunner", "Tuba Gunner", 350, 45, 50, lt_2, 60, 12)
...
label start_fight_quest2:
    ...
    # Create boss
    $e = Enemy("heavy gunner", "Heavy Gunner", 1000, 60, 60, lt_2_boss, 200, 25)
...
label start_fight_miniQuest3:
    ...
    # Create mini boss
    $e = Enemy("fencer 1", "Violin Fencer", 1750, 105, 95, lt_3, 250, 23)
...
label start_fight_quest3:
    ...
    # Create boss
    $e = Enemy("fencer 2", "Violin Fencer", 1300, 140, 115, lt_3_boss, 0, 32)
...
label start_fight_quest4:
    ...
    # Create mini boss
    $e = Enemy("knight", "Tuba Knight", 2000, 150, 250, lt_4_boss, 300, 30)
...
label start_fight_quest4a:
    ...
    # Create boss
    $e = Enemy("king 1", "Tuba King", 3000, 180, 200, lt_4_boss, 350, 40)
...
label start_fight_quest4b:
    ...
    # Create boss
    $e = Enemy("king 2", "Tuba King", 2999, 200, 180, lt_4_boss, 500, 45)
...
label start_fight_option2:
    ...
    # Create boss
    $e = Enemy("queen", "Tuba Queen", 5000, 220, 150, lt_4_boss, 0, 100)
...
label start_fight_option2a:
    ...
    # Create boss
    $e = Enemy("queen 2", "Tuba Queen", 666, 240, 390, lt_4_boss, 100000, 10000)
